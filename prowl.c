...
//#include "CppTimer.h"
    ...
    {
      /*
       * WOULD I INSERT THE DIFFERENT TIME CONDITIONS FOR THE MESSAGES IN HERE???
       * eg for our 3 messages:
       * 
       * if ( timer1 = 30 ){ 
       *    priority = 0; (not important)
       *    event_name = "Milk out of the fridge"; 
       *    description = "Milk has been out of the fridge for 30mins. Please put it back.";
       * }
       * 
       * elseif ( Tm = Tr ){
       *    priority = 1; (important)
       *    event_name = "Warning: milk is at room temperature."; 
       *    description = "Milk has now reached room temperature. You have two hours to return it to the fridge
       *                   before it becomes unsafe to drink.";
       * }
       * elseif ( timer2 = 120 ){ where timer2 starts when Tm = Tr
       *    priority = 2; (very important)
       *    event_name = "Hazard: milk isn't safe."; 
       *    description = "Milk has now been at room temperature for 2 hours. It is strongly advised
                   not to drink this.";
       * }
       */   
